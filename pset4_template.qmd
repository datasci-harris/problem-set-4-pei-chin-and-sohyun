...
# Save the confirmed closures as a CSV file
confirmed_closures_df.to_csv('C:\\Users\\Pei-Chin\\Desktop\\新增資料夾\\hi Dropbox\\Lu Pei-Chin\\confirmed_closures.csv', index=False)
print("Confirmed closures have been saved to confirmed_closures.csv")
...
# Calculate distance for each ZIP in the Texas to the nearest ZIP with a hospital
...
# Transform to EPSG:4269 to match Texas ZIP codes with hospital distance data
...
# Plot hospital distance data for each Texas ZIP code with color mapping
...
3. 
4. 
>>>>>>> 0e4e108a296ca1920cbdaa0ec7dcb6032081f4a2

# Load the confirmed hospital closures data
confirmed_closures_df = pd.read_csv(r'C:\Users\Pei-Chin\Desktop\新增資料夾\hi Dropbox\Lu Pei-Chin\confirmed_closures.csv')
...
zip_shapefile_path = r"C:\Users\Pei-Chin\Desktop\新增資料夾\hi Dropbox\Lu Pei-Chin\gz_2010_us_860_00_500k\gz_2010_us_860_00_500k.shp"
...
# Check .prj file to find the unit: degree
prj_file_path = "C:/Users/Pei-Chin/Desktop/新增資料夾/hi Dropbox/Lu Pei-Chin/gz_2010_us_860_00_500k/gz_2010_us_860_00_500k.prj"
...
# Load the Texas ZIP codes shapefile
zip_shapefile_path = (
    r"C:\Users\Pei-Chin\Desktop\新增資料夾\hi Dropbox\Lu Pei-Chin\gz_2010_us_860_00_500k\gz_2010_us_860_00_500k.shp"
)
zip_gdf = gpd.read_file(zip_shapefile_path)

# Filter for Texas ZIP codes (starting with '75' or '77')
texas_zip_gdf = zip_gdf[zip_gdf['ZCTA5'].astype(str).str.startswith(('75', '77'))].copy()

# Load the confirmed hospital closures data
confirmed_closures_path = r'C:\Users\Pei-Chin\Desktop\新增資料夾\hi Dropbox\Lu Pei-Chin\confirmed_closures.csv'
confirmed_closures_df = pd.read_csv(confirmed_closures_path)
...
# Add 'affect' column for visualization purposes
affected_zip_gdf.loc[affected_zip_gdf['closure_count'] > 0, 'affect'] = 'Directly Affected'
affected_zip_gdf['affect'] = affected_zip_gdf['affect'].fillna('Not Affected')

# Plot the choropleth map
fig, ax = plt.subplots(figsize=(10, 10))
affected_zip_gdf.plot(
    column='closure_count', cmap='Reds', linewidth=0.8, ax=ax, edgecolor='0.8', legend=True
)
plt.title("Texas ZIP Codes Directly Affected by Hospital Closures (2016-2019)")
plt.xlabel("Longitude")
plt.ylabel("Latitude")
...
1.The "first-pass" method for identifying hospital closures has limitations, including potential 
...
1. 
2. 
Using provider_id instead of ZIP codes could provide a more accurate assessment of hospital accessibility. The ZIP code approach only considers hospital availability within boundaries, which may overlook accessibility in nearby ZIP codes. In contrast, tracking by provider_id allows us to accurately monitor each hospital’s location and status, thus capturing changes in accessibility that extend beyond ZIP code boundaries.
>>>>>>> 0e4e108a296ca1920cbdaa0ec7dcb6032081f4a2
