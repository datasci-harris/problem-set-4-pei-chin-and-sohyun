...
```{python}
import pandas as pd
file_path = r"C:\UChicago\python2\pos2016.csv.csv"
data = pd.read_csv(file_path)
```
    a.
```{python}
...
# Define file paths for each year
file_paths = {
    '2016': r"C:\UChicago\python2\pos2016.csv.csv",
    '2017': r"C:\UChicago\python2\pos2017.csv.csv",
    '2018': r"C:\UChicago\python2\pos2018.csv.csv",
    '2019': r"C:\UChicago\python2\pos2019.csv.csv"
}
...
confirmed_closures_df.to_csv(r'C:\UChicago\python2\gz_2010_us_860_00_500k\confirmed_closures.csv', index=False)
...
# Load the ZIP code shapefile
shapefile_path = r"C:\UChicago\python2\gz_2010_us_860_00_500k\gz_2010_us_860_00_500k.shp"
zip_gdf = gpd.read_file(shapefile_path)
...
# Load the cleaned POS hospital data for 2016
pos_data_path = r"C:\UChicago\python2\pos2016.csv.csv"
pos_df = pd.read_csv(pos_data_path, dtype={'ZIP_CD': str}, low_memory=False)
...
# Re-project to a projected CRS for accurate distance calculations (e.g., EPSG:5070)
subset_texas_zips = subset_texas_zips.to_crs(epsg=5070)
...
# Re-project both GeoDataFrames to EPSG:5070 (projected CRS for distance calculations)
...
```{python}
# Check .prj file to find the unit : degree
with open(r"C:\UChicago\python2\gz_2010_us_860_00_500k\gz_2010_us_860_00_500k.prj", "r") as prj_file:
    prj_content = prj_file.read()
    print(prj_content)
...
confirmed_closures_df = pd.read_csv(r'C:\UChicago\python2\confirmed_closures.csv')
...
# Load the Texas ZIP codes shapefile
zip_shapefile_path = r"C:\UChicago\python2\gz_2010_us_860_00_500k\gz_2010_us_860_00_500k.shp"
zip_gdf = gpd.read_file(zip_shapefile_path)
...
# Check .prj file to find the unit: degree
prj_file_path = r"C:\UChicago\python2\gz_2010_us_860_00_500k\gz_2010_us_860_00_500k.prj"
with open(prj_file_path, "r") as prj_file:
    prj_content = prj_file.read()
    print("Projection file content:\n", prj_content)
...
>>>>>>>> 54507de42bb727c8d848bf62e95f6e7b27e8ac2c:pset4_template.qmd
